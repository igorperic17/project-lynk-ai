    ...
    <>
      {display && (
        <div className="fixed inset-0 bg-black bg-opacity-90 flex justify-center items-center">
          <div className="border min-w-[500px] min-h-[300px] justify-center items-center flex-row border-blue-900 bg-blue-950/30 p-8 rounded-lg shadow-lg transition-transform transform duration-800 ease-in-out">
            {children}
